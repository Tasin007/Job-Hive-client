        ...
        <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl text-white font-semibold">
              Success Stories from Our Job Seekers and Employers
            </h2>
          </div>
          {/* End Title */}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
                <div className="flex-auto p-4 md:p-6">
                  <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                    "This platform has revolutionized our recruitment process. We have found incredibly talented individuals with ease."
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-700">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <img className="h-8 w-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]" src="https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Profile Picture" />
                    </div>
            ...
            <div className="flex h-auto">
              <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
                <div className="flex-auto p-4 md:p-6">
                  <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                    "I landed my dream job within weeks of signing up. The guidance and support from the site were phenomenal!"
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-700">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <img className="h-8 w-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWgefHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Profile Picture" />
                    </div>
                    ...
                    <div className="grow ml-3">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        Software Developer | Recently Hired
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex h-auto">
              <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
                <div className="flex-auto p-4 md:p-6">
                  <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                    "As a small business owner, finding the right talent was a challenge. This job site connected me with skilled professionals quickly."
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-700">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <img className="h-8 w-8 rounded-full sm:h-[2.875rem] sm:w-[2.875rem]" src="https://images.unsplash.com/photo-1579017331263-ef82f0bbc748?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWgefHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=900&h=900&q=80" alt="Profile Picture" />
                    </div>
          ...
          <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
            ...
            <div>
              ...
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">89.95%</p>
              <p className="mt-1 text-gray-400">in fulfilling requests</p>
            </div>
            {/* End Stats */}
  
            {/* Stats */}
            <div>
              <h4 className="text-lg sm:text-xl font-semibold text-white">Job Placement</h4>
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">26,000+</p>
              <p className="mt-1 text-gray-400">People with JobHive</p>
            </div>
            {/* End Stats */}
            ...
            <div>
              ...
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">87%</p>
